...
export var patternPK = /^[G,g][a-zA-Z0-9]{55}$/;
export var patternSK = /^[S,s][a-zA-Z0-9]{55}$/;
export var patternId = /^[S,N,s,n][T,N,t,n][T,N,t,n][A,N,a,n][a-zA-Z0-9][T,N,t,n][a-zA-Z0-9]{6}$/;
//prod
// // export var niftronUserLambda = "http://localhost:7000/api/v1";
